...
-- vim & tmux split resizing in windows
-- because windows is stupid af
vim.keymap.set("n", "<S-M-h>", function() tmux.resize_left() end)
vim.keymap.set("n", "<S-M-j>", function() tmux.resize_bottom() end)
vim.keymap.set("n", "<S-M-k>", function() tmux.resize_top() end)
vim.keymap.set("n", "<S-M-l>", function() tmux.resize_right() end)
